...
namespace GeminiCommerce\Tokentracker;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://token-tracker.api.gogemini.io';
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\Tokentracker) Debug Report:' . PHP_EOL;
